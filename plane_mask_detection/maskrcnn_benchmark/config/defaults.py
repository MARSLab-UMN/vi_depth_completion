...
_C.INPUT.MIN_SIZE_TRAIN = (960,)  # (800,)
# Maximum size of the side of the image during training
_C.INPUT.MAX_SIZE_TRAIN = 1280
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST = 960
...
_C.SOLVER.UNSUPERVISED = CN()
_C.SOLVER.UNSUPERVISED.PLANE_NORMAL = 1

# Supervised training:
_C.SOLVER.SUPERVISED = "plane_normal"

# Output Representation:
# 0: estimate directly 3 values of normal vector w/o any particular constraints, follows by normalization
  # 1: estimate [stt, ctt, phi] w/ geometric constraints loss function
_C.SOLVER.OUTPUT_REPRESENTATION = 0
...
# Evaluate delta, slant, or tilt
_C.TEST.EVALUATE_ANGLE = "delta"
_C.TEST.VISUALIZATION = 0
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "."
